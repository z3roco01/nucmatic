...
object NucmaticBlockEntityTypes {
    ...
    val REACTOR_CONTROLLER_TYPE = BlockEntityType.Builder.create(::ReactorControllerBlockEntity,
        NucmaticBlocks.REACTOR_CONTROLLER).build()
    ...
    fun register() {
        ...
        registerEnergyContainer("generator_controller", REACTOR_CONTROLLER_TYPE)
    }
