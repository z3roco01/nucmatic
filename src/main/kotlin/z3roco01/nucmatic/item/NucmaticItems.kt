...
object NucmaticItems {
    ...
    val NU_FUEL  = NuclearFuelItem(64000, 400, 0.0005f, 1, (20..40), Settings()) // natural uranium fuel, used in some reactors
    val LEU_FUEL = NuclearFuelItem(128000, 600, 0.001f,  1, (20..80), Settings()) // low enriched uranium fuel, used in most reactors
    val HEU_FUEL = NuclearFuelItem(256000, 800, 0.005f,  2, (20..80), Settings()) // high enriched uranium fuel, used mostly in weapons
    // hazmat armour items
